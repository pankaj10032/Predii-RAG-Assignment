...
class RAGBenchmark:
    ...
    def run_query(self, rag_pipeline, query: str, approach: str, is_advanced: bool = False) -> BenchmarkResult:
    ...
    def run_benchmark_suite(self, naive_rag, advanced_rag, test_queries: List[Dict[str, str]]):
    ...
    def print_comparison(self):
        ...
        naive_tokens = naive_summary.avg_context_length * 1000 / 4
        advanced_tokens = advanced_summary.avg_context_length * 1000 / 4
        naive_cost = (naive_tokens / 1_000_000) * 0.15
        ...
        if latency_diff < 20:
            ...
            print("Latency overhead is significant (consider optimization)")
