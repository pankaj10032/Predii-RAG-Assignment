...
class AdvancedRAGPipeline:
    ...
    def benchmark_mode(self, test_queries: Optional[List[str]] = None) -> Dict[str, Any]:
        ...
        for i, query in enumerate(test_queries, 1):
            ...
            print(f"   {query_time:.2f}s | {result.num_chunks_used} chunks | {result.faithfulness_score:.3f if result.faithfulness_score else 'N/A'}")
    ...
    def _show_history(self):
        ...
        for i, entry in enumerate(self.query_history[-10:], 1):
            ...
            print(f"   {result.latency_ms:.0f}ms | {result.num_chunks_used} chunks | {result.faithfulness_score:.3f if result.faithfulness_score else 'N/A'}")
